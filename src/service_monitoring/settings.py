"""
Django settings for service_monitoring project.
...
SECRET_KEY = 'u*u$ps!^^bge20yba&1reu8*k$6((ek2-%x^dlc)ar_g-u+xy!'
...
ROOT_URLCONF = 'service_monitoring.urls'
...
WSGI_APPLICATION = 'service_monitoring.wsgi.application'
